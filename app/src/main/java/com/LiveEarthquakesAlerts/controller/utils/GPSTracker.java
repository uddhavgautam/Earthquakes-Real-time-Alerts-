...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static GPSTracker gpsTracker = new GPSTracker(MainActivity.mainContext);
    ...
    public static GPSTracker getInstance() {
        if (gpsTracker == null) {
            gpsTracker = new GPSTracker(MainActivity.mainContext);
        }
        return gpsTracker;
    }
    ...
    public void setLocation() {
        try {
            locationManager = (LocationManager) MainActivity.mainContext.getSystemService(LOCATION_SERVICE);
